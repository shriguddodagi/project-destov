          ...
          <ul class="list-unstyled footer-list text-center">
            ...
            <div class="container"  style="color:white; display:contents">
              ...
              <div class="margin-b-10" style="display: -webkit-inline-box; text-align: center;">
                <div>
                  <i class="fa fa-lg fa-tag fa-map-marker margin-r-10"></i>
                </div>
                <div>
                  Shop No.04, Olive Excel<br>Seawoods, Sector-42<br>New Mumbai - 400 706
                </div>
              </div><br>
              <div class="margin-b-10" style="display: -webkit-inline-box; text-align: center;">
                <div>
                  <strong><i class="fa fa-lg fa-tag fa-phone margin-r-10"></i></strong>
                </div>
                <div>+91 8082087255</div>
              </div><br>
              <div class="margin-b-10" style="display: -webkit-inline-box; text-align: center;">
                <div>
                  <strong><i class="fa fa-lg fa-tag fa-envelope margin-r-10"></i></strong>
                </div>
