<div id="feedback" class="container content text-center margin-b-40">
  <div class="col-sm-12 sm-margin-b-30">
    ...
    <h4 
	    ...
	    width: max-content;
	    display: inline-flex;
	    padding: 5px 30px;">We'd Love To Hear From You</h4>
    <h5 class="text-center text-white bg-success rounded d-block" 
    	style="padding: 15px; display: <?php echo (isset($_SESSION['feedbackDone'])) ? "block" : "none"; ?>; border-radius: 10px; "><?php if (isset($_SESSION['feedbackDone'])) { echo "THANK YOU! FOR YOUR VALUABLE FEEDBACK"; } ?></h5>
